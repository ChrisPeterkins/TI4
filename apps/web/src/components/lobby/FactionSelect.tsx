  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        disabled={disabled}
        className={`w-full p-3 bg-gray-700 rounded-lg text-left flex items-center justify-between ${
          ...
          {availableFactions.map((faction) => {
            ...
            return (
              <button
                ...
                disabled={isTaken}
                className={`w-full p-3 text-left flex items-center justify-between border-b border-gray-700 last:border-0 ${
                  isSelected
                    ? 'bg-blue-600'
                    : isTaken
